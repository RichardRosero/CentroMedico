...
$("#fecha_cita").on("dp.change", function(e) {  
    let fecha = new Date(e.date).toLocaleDateString();
    console.log(fecha); 
    CargaHoras(fecha);       
    
});

$('#id_id_doctor').on('change', function() {
    let fecha = document.querySelector('[name=fecha_cita]').value;
